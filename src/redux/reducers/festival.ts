...
export const GET_FESTIVAL_DETAIL_REQUEST = "festival/GET_FESTIVAL_DETAIL_REQUEST";
export const GET_FESTIVAL_DETAIL_SUCCESS = "festival/GET_FESTIVAL_DETAIL_SUCCESS";
